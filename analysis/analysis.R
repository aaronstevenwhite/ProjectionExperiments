...
setwd('~/experiments/ProjectionExperiments/analysis/')
source('filter.R')
...
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawhierotreeverb.tikz', width=6, height=5)
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawhierotreeframe.tikz', width=6, height=5)
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawhieroheat.tikz', width=6, height=4)
# p.frame.raw
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawpcaverb.tikz', width=6, height=4)
# p.frame.pca.verb
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawpcaframe.tikz', width=6, height=4)
# p.frame.pca.frame
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawpcaverb2.tikz', width=6, height=4)
# p.frame.pca.verb2
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framerawpcaframe2.tikz', width=6, height=4)
# p.frame.pca.frame2
# dev.off()
...
waic <- read.csv("~/experiments/ProjectionExperiments/analysis/model/likert_factor_analysis/waic_discrete", header=FALSE)
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/waic.tikz', width=6, height=4)
# p.waic
# dev.off()

## load features and loadings
verb.features <- read.csv("~/experiments/ProjectionExperiments/analysis/model/likert_factor_analysis/discrete/verbfeatures_14.csv", sep=";")
feature.loadings <- read.csv("~/experiments/ProjectionExperiments/analysis/model/likert_factor_analysis/discrete/featureloadings_14.csv", sep=";")
...
feature.order <- verb.features$feature[order(featuresum)]
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/featureloadingsnonnegative.tikz', width=6, height=4)
# p.feature.loadings.frame
# dev.off()

## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/verbfeaturesnonnegative.tikz', width=6, height=4)
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/triadraw.tikz', width=6, height=4)
# p.triad.raw
# dev.off()
...
## uncomment to produce tikz graph
#tikz('~/experiments/ProjectionExperiments/analysis/plots/triadnonmetricmds.tikz', width=6, height=4)
#p.triad.embedding
#dev.off()

## likert similiarity heatmap
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/likertsimraw.tikz', width=6, height=4)
# p.likert.raw
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/likertnonmetricmds.tikz', width=6, height=4)
# p.likert.embedding
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/triadlikertraw.tikz', width=6, height=4)
# p.sim.cor
# dev.off()
...
## uncomment to produce tikz graph
# tikz('~/experiments/ProjectionExperiments/analysis/plots/framesimraw.tikz', width=6, height=4)
# p.dist.frame.sim
# dev.off()
